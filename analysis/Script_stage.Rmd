...
semble fonctionner mais affiche: "Avis dans ps^q : la taille d'un objet plus long n'est pas multiple de la taille d'un objet plus court"

Je ne comprends pas à quoi ela fait réference.
