...
```{r}
x <- sapply(motus$sequence[1:15], lcs_score, motus$sequence[1:15], similarity_mode = "distance")
matrice_distance <- matrix(unlist(x), nrow = length(motus$sequence[1:15]), ncol = length(motus$sequence[1:15]), byrow = T)
