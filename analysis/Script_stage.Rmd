...
```{r}
x <- sapply(motus$sequence[1:10], lcs_score, motus$sequence[1:10], similarity_mode = "distance")
matrice_distance <- matrix(unlist(x), nrow = length(motus$sequence[1:10]), ncol = length(motus$sequence[1:10]), byrow = T)
