...
vecteur <- c(rep(1,length(nom_sample)*length(nombre_q))) #création d'un vecteur de taille nombre d'échantillons * nombre de valeurs de q
...
for (a in 0:(length(nom_sample)-1)) {
  tableau[(a*length(nom_sample)+1):(a*length(nom_sample)+5),"sample"] <-rep("non",5)
}
tableau
```
